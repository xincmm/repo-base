    ...
    <MarkdownTextPrimitive
      ...
      components={{
        ...
        p: ({ node: _node, className, ...props }) => (
          <p className={cn("mb-2 mt-2 leading-7 first:mt-0 last:mb-0", className)} {...props} />
        ),
        ...
        hr: ({ node: _node, className, ...props }) => <hr className={cn("my-5 border-b", className)} {...props} />,
        ...
        pre: ({ node: _node, className, ...props }) => (
          <pre className={cn("overflow-x-auto rounded-b-lg bg-black p-2 text-white", className)} {...props} />
        ),
        code: function Code({ node: _node, className, ...props }) {
          const isCodeBlock = useIsMarkdownCodeBlock();
          console.log("isCodeBlock =>", isCodeBlock);
          return (
            <code className={cn(!isCodeBlock && "bg-aui-muted rounded border font-semibold", className)} {...props} />
          );
        },
        CodeHeader,
        SyntaxHighlighter,
...
const CodeHeader: FC<CodeHeaderProps> = ({ language, code }) => {
  ...
  return (
    <div className="flex items-center justify-between border-b gap-4 rounded-t-lg bg-[#f9f9f9] px-4 py-2 text-sm font-semibold text-black">
