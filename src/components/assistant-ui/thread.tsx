  ...
  return (
    <ComposerPrimitive.Root className="focus-within:border-ring/20 flex w-full flex-wrap items-end  border bg-inherit px-2.5 shadow-xs transition-colors ease-in rounded-lg">
      <ComposerPrimitive.Input
        ...
        className="placeholder:text-muted-foreground max-h-40 grow resize-none border-none bg-transparent px-2 py-4 text-sm outline-hidden focus:ring-0 disabled:cursor-not-allowed"
      />
      <ComposerAction />
